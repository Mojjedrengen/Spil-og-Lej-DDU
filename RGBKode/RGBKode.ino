...
const char* MQTT_CLIENT_ID = "FAMSRGB";
...
void gameLoop(){
  ...
  if (codeIndex >= 6){
    pubSubClient.publish("DDU4/FAMS/SpilOgLej", "RGBKodeIsDone");
    isGame = false;
...
// RGB kode program.
// Program er helt færdig. MQTT virker også
// R = 0
// G = 1
// B = 2